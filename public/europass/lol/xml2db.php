...
foreach($identifications as $identification)
{
    ...
    mysqli_query($link,"INSERT INTO mob_xml (ID,  FNAME, LNAME, ADDRESS, MUNIC, POSTAL_CODE, CODE_COUNTRY, COUNTRY, PHONE,
                ...
                or die('Could not insert data in Master XML table!!!!<br/><center><a href="../webapp">Go Back</a></center>'.mysqli_error($link));
    ...
    foreach ($nationalities as $nationality) {
        ...
        mysqli_query($link,"INSERT INTO mob_nationality (ID, XML_ID, CODE, NATIONALITY)
                    ...
                    or die('Could not insert data in Nationality Table<br/><center><a href="../webapp">Go Back</a></center>'.mysqli_error($link));
    }
}
...
if ($workexperiencelist->length > 0)
    ...
    foreach ($workexperiencelist as $workexperience) {
        ...
        or die('Could not insert data in Work Experience table!!!!<br/><center><a href="../webapp">Go Back</a></center>'.mysqli_error($link));
...
if ($educationlist->length > 0)
    ...
    foreach ($educationlist as $education) {
        ...
        mysqli_query($link,"INSERT INTO mob_education (ID, XML_ID, TITLE, SUBJECT, ORG_NAME, ORG_ADDRESS, ORG_MUNIC,
											    ORG_ZCODE, CODE_COUNTRY, COUNTRY, EDULEVEL,EDU_FIELD,
												DAY_FROM, MONTH_FROM, YEAR_FROM, DAY_TO, MONTH_TO, YEAR_TO)
										VALUES (NULL,'$xmlid','$title','$eskills','$ename','$eaddress','$ecity','$epcode',
												'$educcode','$educlabel','$edullabel','$eduflabel',
												'$efday','$efmonth','$efyear','$etday','$etmonth','$etyear')")
                    or die('Could not insert data in Education table!!!!<br/><center><a href="../webapp">Go Back</a></center>'.mysqli_error($link));
    }
...
foreach ($foreignLanguagelists as $language) {
    ...
    mysqli_query($link,"INSERT INTO mob_language (ID, XML_ID, CODE_LANGUAGE, OLANGUAGE, LISTENING, READING,
                    ...
                    or die('Could not insert data in Other Languages table!!!!<br/><center><a href="../webapp">Go Back</a></center>'.mysqli_error($link));
}
...
mysqli_query($link,"UPDATE mob_xml
				 SET SOCIAL           = '$social',
					 ...
					 OTHER			  = '$other'
				 WHERE ID = '$xmlid'")
        or die('Could not update data in Master table with skills/competences data!!!!<br/><center><a href="../webapp">Go Back</a></center>'.mysqli_error($link));
...
if ($drivingcnt > 0) {
    for ($idx = 0; $idx < $drivingcnt; $idx++) {
        ...
        or die('Could not insert data in Driving Skill table!!!!<br/><center><a href="../webapp">Go Back</a></center>');
    }
}
